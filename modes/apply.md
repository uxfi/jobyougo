...
Free-text answers follow `modes/question.md` Step 4. Read the copywriting ATS skill, then copy-editing ATS pass, humanizer, and stop-slop (`~/.codex/skills/`). Optional fields stay empty unless the candidate asks to fill them.
