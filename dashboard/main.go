...
type appModel struct {
	...
	answerHint    string // printed after TUI exits (set by PipelineAnswerQuestionMsg)
}
...
func (m appModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case screens.PipelineAnswerQuestionMsg:
		m.answerHint = fmt.Sprintf("\n\033[1;36mAnswer a question for:\033[0m %s — %s\n\033[1;33mRun:\033[0m claude \"réponds à cette question pour %s (%s) : YOUR QUESTION HERE\"\n", msg.Company, msg.Role, msg.Company, msg.Role)
		return m, tea.Quit
...
func main() {
	...
	if am, ok := finalModel.(appModel); ok && am.answerHint != "" {
		fmt.Print(am.answerHint)
	}
}
