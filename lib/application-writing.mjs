...
- Apply an editorial pass inspired by Humanizer and Copy Editing: remove staged openings, dramatic fragments, unsupported superlatives, artificial contrasts ('not X, but Y'), and closing sentences that merely repeat the answer. Keep concrete technical distinctions and actual lists when they explain the work.
- Check clarity, voice, relevance, evidence and specificity in that order. Never manufacture a benefit, number, emotion or anecdote to make the copy more persuasive. A concise factual answer may need no project example at all.
